...
from lib.datasets.mdm.humanml.motion_loaders.model_motion_loaders import get_mdm_loader  # get_motion_loader
from lib.datasets.mdm.humanml.utils.metrics import *
from lib.datasets.mdm.humanml.networks.evaluator_wrapper import EvaluatorMDMWrapper
from collections import OrderedDict
from lib.datasets.mdm.humanml.scripts.motion_process import *
from lib.datasets.mdm.humanml.utils.utils import *
from lib.networks.make_network import make_network, create_gaussian_diffusion, load_model_wo_clip

from lib.utils.diffusion import logger
...
if __name__ == '__main__':
    ...
    split = 'test'
    gt_loader = get_data_loader(name=args.dataset, batch_size=args.batch_size, num_frames=None, split=split, hml_mode='gt')
    gen_loader = get_data_loader(name=args.dataset, batch_size=args.batch_size, num_frames=None, split=split, hml_mode='eval')
    num_actions = gen_loader.dataset.num_actions

    logger.log("Creating model and diffusion...")
    # model, diffusion = create_model_and_diffusion(args, gen_loader)
    model = make_network(args, gen_loader)
