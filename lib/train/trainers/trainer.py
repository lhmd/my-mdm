...
from lib.utils.diffusion.fp16_util import MixedPrecisionTrainer
from lib.utils.diffusion.resample import LossAwareSampler, UniformSampler
from tqdm import tqdm
from lib.utils.diffusion.resample import create_named_schedule_sampler
from lib.datasets.mdm.humanml.networks.evaluator_wrapper import EvaluatorMDMWrapper
from lib.train.eval import eval_humanml, eval_humanact12_uestc
...
class Trainer(object):
    def __init__(self, args, train_platform, model, diffusion, data):
        ...
        if args.dataset in ['kit', 'humanml'] and args.eval_during_training:
            ...
            gen_loader = get_data_loader(name=args.dataset, batch_size=args.eval_batch_size, num_frames=None,
                                            split=args.eval_split,
                                            hml_mode='eval')

            self.eval_gt_data = get_data_loader(name=args.dataset, batch_size=args.eval_batch_size, num_frames=None,
                                                   split=args.eval_split,
                                                   hml_mode='gt')
