...
from lib.datasets.mdm.humanml.common.skeleton import Skeleton
import numpy as np
import os
from lib.datasets.mdm.humanml.common.quaternion import *
from lib.datasets.mdm.humanml.utils.paramUtil import *
...
if __name__ == "__main__":
    ...
    joints_num = 22
    # ds_num = 8
    data_dir = '../data/pose_data_raw/joints/'
    save_dir1 = '../data/pose_data_raw/new_joints/'
    save_dir2 = '../data/pose_data_raw/new_joint_vecs/'
...
if __name__ == "__main__":
    ...
    joints_num = 21
    # ds_num = 8
    data_dir = '../data/kit_mocap_dataset/joints/'
    save_dir1 = '../data/kit_mocap_dataset/new_joints/'
    save_dir2 = '../data/kit_mocap_dataset/new_joint_vecs/'
