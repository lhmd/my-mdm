...
from lib.datasets.mdm.humanml.utils.word_vectorizer import WordVectorizer
from lib.datasets.mdm.humanml.utils.get_opt import get_opt
...
class HumanML3D(data.Dataset):
    def __init__(self, mode, datapath='./data/humanml_opt.txt', split="train", **kwargs):
        self.mode = mode
...
# A wrapper class for t2m original dataset for MDM purposes
class KIT(HumanML3D):
    def __init__(self, mode, datapath='./data/kit_opt.txt', split="train", **kwargs):
